...
declare global {
    ...
    export namespace IEditor {
        ...
        export interface ISelectResourceDialog extends IDialog {
             ...
             * @param allowInternalAssets Whether to allow internal assets. Default is true.
        ...
        export interface IDataInspector {
            ...
            /**
             * Check all referenced types to see if they have been updated. If any updated types are detected, all fields will be rebuilt. 
             * This method is used to update the inspector when the type of the object being inspected changes.
             * @returns Whether the types have been updated and the inspector has been rebuilt.
             */
        ...
        export interface IAssetPanel {
             ...
             * @param arr The expanded folders
             */
            setExpanedFolders(arr: ReadonlyArray<string>): void;
        ...
        export interface IAssetDb {
            ...
            /**
             * Get the file actions by the asset type.
             * @param assetType The type of the asset.
             * @returns The file actions of the asset.
             */
        ...
        export interface IPlayControls extends gui.Widget {
             ...
             * @param where Where to play the scene. 
             ...
             */
            getPlayURL(currentOrStartup?: boolean): string;
        }
        ...
        export class NodeRefInput extends gui.Label {
            ...
            /**
             * The type name of the node. Default is "Node".
             */
            typeName?: string;
            constructor();
            get value(): IMyNode;
        ...
        */
         ...
         * @param name menu item name of path. Paths are separated by "/", "App/tool/test" represents the test item under the tool submenu of the App menu. Note that the path here uses IDs, not the text displayed in the menu. All menu names and their submenus supported by the editor can be printed out for reference using the menu Developer > Print All Menu IDs.
