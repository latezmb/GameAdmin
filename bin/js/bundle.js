(() => {
  ...
  __name(_FrameConfig, "FrameConfig");
  /**版本号，跟随提交版本变化 */
  ...
  var game;
  ((game2) => {
    const _TbLocalInfo = class _TbLocalInfo {
      constructor(_json_) {
    ...
    __name(_TbLocalInfo, "TbLocalInfo");
    let TbLocalInfo = _TbLocalInfo;
    game2.TbLocalInfo = _TbLocalInfo;
  })(game || (game = {}));
  ((game2) => {
    const _LocalInfo = class _LocalInfo {
      constructor(_json_) {
    ...
    __name(_LocalInfo, "LocalInfo");
    let LocalInfo = _LocalInfo;
    game2.LocalInfo = _LocalInfo;
  })(game || (game = {}));
  ((game2) => {
    const _TbConstant = class _TbConstant {
      constructor(_json_) {
        this._dataMap = /* @__PURE__ */ new Map();
        this._dataList = [];
        for (var _json2_ of _json_) {
    ...
    __name(_TbConstant, "TbConstant");
    let TbConstant = _TbConstant;
    game2.TbConstant = _TbConstant;
  })(game || (game = {}));
  ((game2) => {
    ...
    __name(_Constant, "Constant");
    let Constant = _Constant;
    game2.Constant = _Constant;
  })(game || (game = {}));
  ...
  __name(_Scene3DManager, "Scene3DManager");
  var Scene3DManager = _Scene3DManager;
  ...
  __name(_HashElement, "HashElement");
  var HashElement = _HashElement;
  var _ActionManager = class _ActionManager {
    constructor() {
  ...
  __name(_ActionManager, "ActionManager");
  var ActionManager = _ActionManager;
  ...
  __name(_TweenSystem, "TweenSystem");
  /**
   * @en
  ...
  var Action = _Action;
  var _FiniteTimeAction = class _FiniteTimeAction extends Action {
    constructor() {
      super(...arguments);
      this._duration = 0;
  ...
  __name(_FiniteTimeAction, "FiniteTimeAction");
  var FiniteTimeAction = _FiniteTimeAction;

  // src/frame/tween/actions/action-instant.ts
  var _ActionInstant = class _ActionInstant extends FiniteTimeAction {
    isDone() {
      return true;
    }
    step(dt) {
  ...
  __name(_ActionInstant, "ActionInstant");
  var ActionInstant = _ActionInstant;
  var _Show = class _Show extends ActionInstant {
    update(dt) {
    }
    reverse() {
      return new Hide();
  ...
  __name(show, "show");
  var _Hide = class _Hide extends ActionInstant {
    update(dt) {
    }
    reverse() {
      return new Show();
  ...
  __name(hide, "hide");
  var _RemoveSelf = class _RemoveSelf extends ActionInstant {
  ...
  __name(_RemoveSelf, "RemoveSelf");
  var RemoveSelf = _RemoveSelf;
  function removeSelf(isNeedCleanUp) {
    return new RemoveSelf(isNeedCleanUp);
  }
  __name(removeSelf, "removeSelf");
  var _CallFunc = class _CallFunc extends ActionInstant {
    /*
  ...
  __name(_CallFunc, "CallFunc");
  var CallFunc = _CallFunc;
  function callFunc(selector, selectorTarget, data) {
    return new CallFunc(selector, selectorTarget, data);
  }
  __name(callFunc, "callFunc");

  // src/frame/tween/actions/action-interval.ts
  var _ActionInterval = class _ActionInterval extends FiniteTimeAction {
  ...
  __name(_ActionInterval, "ActionInterval");
  var ActionInterval = _ActionInterval;
  ...
  _Sequence._actionOneTwo = /* @__PURE__ */ __name(function(actionOne, actionTwo) {
  ...
  var _Repeat = class _Repeat extends ActionInterval {
  ...
  __name(_Repeat, "Repeat");
  var Repeat = _Repeat;
  function repeat(action, times) {
    return new Repeat(action, times);
  }
  __name(repeat, "repeat");
  var _RepeatForever = class _RepeatForever extends ActionInterval {
    constructor(action) {
      super();
      this._innerAction = null;
  ...
  __name(_RepeatForever, "RepeatForever");
  var RepeatForever = _RepeatForever;
  function repeatForever(action) {
    return new RepeatForever(action);
  }
  __name(repeatForever, "repeatForever");
  ...
  __name(_Spawn, "Spawn");
  _Spawn._actionOneTwo = /* @__PURE__ */ __name(function(action1, action2) {
  ...
  __name(spawn, "spawn");
  var _DelayTime = class _DelayTime extends ActionInterval {
    update(dt) {
    }
    reverse() {
  ...
  __name(_DelayTime, "DelayTime");
  var DelayTime = _DelayTime;
  function delayTime(d) {
    return new DelayTime(d);
  }
  __name(delayTime, "delayTime");
  var _ReverseTime = class _ReverseTime extends ActionInterval {
    constructor(action) {
      super();
      this._other = null;
      action && this.initWithAction(action);
  ...
  __name(_ReverseTime, "ReverseTime");
  var ReverseTime = _ReverseTime;
  function reverseTime(action) {
    return new ReverseTime(action);
  }
  __name(reverseTime, "reverseTime");
  ...
  __name(TweenEasingAdapter, "TweenEasingAdapter");
  ...
  __name(TweenOptionChecker, "TweenOptionChecker");
  var _TweenAction = class _TweenAction extends ActionInterval {
  ...
  __name(_TweenAction, "TweenAction");
  var TweenAction = _TweenAction;

  // src/frame/tween/set-action.ts
  var _SetAction = class _SetAction extends ActionInstant {
    constructor(props) {
      super();
      this._props = {};
  ...
  __name(_SetAction, "SetAction");
  var SetAction = _SetAction;
  ...
  __name(tweenUtil, "tweenUtil");
  window["tweenUtil"] = tweenUtil;

  // src/frame/base/ScriptBase.ts
  var _ScriptBase = class _ScriptBase extends Laya.Script {
    constructor() {
      super(...arguments);
      this.childDic = {};
    }
  ...
  __name(_ScriptBase, "ScriptBase");
  var ScriptBase = _ScriptBase;

  // src/frame/window/ViewBase.ts
  var _ViewBase = class _ViewBase extends ScriptBase {
    constructor() {
      super(...arguments);
  ...
  __name(_ViewBase, "ViewBase");
  var ViewBase = _ViewBase;

  // src/frame/window/WindowBase.ts
  var _WindowBase = class _WindowBase extends ViewBase {
    constructor() {
      super(...arguments);
      /**被触发onHide时要不要调用hide() */
  ...
  __name(_WindowBase, "WindowBase");
  var WindowBase = _WindowBase;
  ...
  var _ModuleConfig = class _ModuleConfig {
    /**
     * 注册窗口
     * @param name 窗口明
     * @param prefab 预制体路径
  ...
  __name(_ModuleConfig, "ModuleConfig");
  _ModuleConfig.module = {};
  var ModuleConfig = _ModuleConfig;

  // src/frame/proxy/ProxyManager.ts
  var _ProxyManager = class _ProxyManager extends Singleton {
    constructor() {
      super();
      this.proxyList = [];
    }
  ...
  __name(_ProxyManager, "ProxyManager");
  var ProxyManager = _ProxyManager;

  // src/frame/sdk/AdBase.ts
  var _AdBase = class _AdBase {
    constructor() {
      this.AdObj = null;
  ...
  __name(_AdBase, "AdBase");
  var AdBase = _AdBase;

  // src/frame/sdk/SDKUtils.ts
  var _SDKUtils = class _SDKUtils {
  };
  __name(_SDKUtils, "SDKUtils");
  /**一个banner爆光次数 */
  _SDKUtils.updateBannerNum = 3;
  var SDKUtils = _SDKUtils;

  // src/frame/sdk/Banner.ts
  var _Banner = class _Banner extends AdBase {
    constructor(id) {
      super();
      this.showNum = 0;
      this.Id = id;
  ...
  var _Custom = class _Custom extends AdBase {
  ...
  var _Grid = class _Grid extends AdBase {
    constructor(id) {
      super();
      this.Id = id;
    }
  ...
  var _InterstitialAd = class _InterstitialAd extends AdBase {
    constructor(id) {
      super();
      this.Id = id;
      this.create();
  ...
  __name(_InterstitialAd, "InterstitialAd");
  var InterstitialAd = _InterstitialAd;
  ...
  var _Video = class _Video extends AdBase {
    constructor(id) {
      super();
      this.caller = null;
      this.finishFun = null;
  ...
  var _DataUtils = class _DataUtils {
    static get Inst() {
  ...
  __name(_DataUtils, "DataUtils");
  var DataUtils = _DataUtils;
  ...
  var _Tools = class _Tools {
    ...
    static findChildByPath(node, path) {
      var arr = path.split("/");
      var fun = /* @__PURE__ */ __name((node2, arr2) => {
  ...
  var _MusicManager = class _MusicManager {
    /**播放音效 */
  ...
  __name(_MusicManager, "MusicManager");
  // 资源根目录
  _MusicManager.MusicBasePath = "resources/audio/";
  var MusicManager = _MusicManager;
  ...
  Start = __decorateClass([
    regClass2("489843f4-77f7-428f-83eb-8236aa329fd8", "../src/game/Start.ts")
  ], Start);

  // src/frame/base/ShapeBase.ts
  var _ShapeBase = class _ShapeBase {
    constructor(owner, centerX, centerY) {
      this.anchorX = 0;
      this.anchorY = 0;
      this.owner = owner;
  ...
  __name(_ShapeBase, "ShapeBase");
  var ShapeBase = _ShapeBase;

  // src/frame/base/Circle.ts
  var _Circle = class _Circle extends ShapeBase {
    constructor(owner, centerX, centerY, radius) {
  ...
  // src/frame/base/Rectangle.ts
  var _Rectangle = class _Rectangle extends ShapeBase {
    constructor(owner, centerX, centerY, width, height, angle = 0) {
      super(owner, centerX, centerY);
      this.width = width;
      this.height = height;
      this.angle = angle;
  ...
  var _MathUtils = class _MathUtils {
     ...
     * @param XAngle X轴的角度
     */
    static twoBezierCurve(P0, P1, P2, timer, result, XAngle = false) {
     ...
     * @param vc2_2 
     */
    static Vc2Distance(vc2_1, vc2_2) {
     ...
     * @param vc2_2 
     */
    static Vc2Distance2(vc2_1, vc2_2) {
      let _diff = new Laya.Vector2(vc2_1.x - vc2_2.x, vc2_1.y - vc2_2.y);
     ...
     */
    static calculateNormalVector(vector, createNew = false) {
      if (createNew) {
     ...
     * @returns 
     */
    static getReverseVector(vector) {
      vector.x = -vector.x;
      vector.y = -vector.y;
      return vector;
    }
  };
  __name(_MathUtils, "MathUtils");
  var MathUtils = _MathUtils;

  // src/frame/collision/ray/RayManager.ts
  var _RayManager = class _RayManager extends Singleton {
    constructor() {
      super();
      this.shapeBaseList = /* @__PURE__ */ new Map();
    }
    /**注册 */
    register(script) {
  ...
  __name(_RayManager, "RayManager");
  var RayManager = _RayManager;

  // src/frame/collision/ray/ShapeScript.ts
  var { regClass: regClass3, property: property3 } = Laya;
  var ShapeType = /* @__PURE__ */ ((ShapeType2) => {
    ShapeType2[ShapeType2["Rectangle"] = 0] = "Rectangle";
    ShapeType2[ShapeType2["Circle"] = 1] = "Circle";
    return ShapeType2;
  })(ShapeType || {});
  var ShapeScipt = class extends Laya.Script {
    constructor() {
      super(...arguments);
      this.onAwakeInit = true;
      this.group = 1;
      this.shapeType = 0 /* Rectangle */;
    ...
    onAwake() {
      this.register();
      if (this.onAwakeInit)
        this.refreshShapeInfo();
    }
    register() {
      if (this.isRegister)
        return;
      this.isRegister = true;
      RayManager.Inst().register(this);
    }
    refreshShapeInfo() {
      let pos = new Laya.Point(this.owner.x, this.owner.y);
      pos = this.owner.parent.localToGlobal(pos);
      ...
      switch (this.shapeType) {
        case 0 /* Rectangle */:
          ...
          if (this.shape) {
            this.shape.setPos(cX, cY);
            this.shape.setSize(cW, cH);
          } else {
     ...
     */
    isLineIntersectRectangle(ray, rec) {
      ...
      let intersectionPointLineStart;
      let intersectionPointLineEnd;
      ...
      if (intersectionPoint) {
        ...
        if (dotProduct >= 0) {
          return { result: true, intersectionPoint, owner: rec.owner, normal, reflexVector };
        }
      }
      return { result: false };
    }
     ...
     * @returns 交点坐标
     */
    calculateIntersectionPoint(p1, p2, p3, p4) {
     ...
     */
    isRayIntersectCircle(ray, circle) {
      let linePoint1 = ray.start;
      let linePoint2 = ray.direction;
      ...
      if (intersectionDistanceSquared < circle.radius * circle.radius) {
        ...
        return { result: true, intersectionPoint, owner: circle.owner };
      }
      return { result: false };
    }
  };
  __name(ShapeScipt, "ShapeScipt");
  __decorateClass([
    property3({ tips: "\u662F\u5426\u5728onAwake\u521D\u59CB\u5316Shape", type: Boolean })
  ], ShapeScipt.prototype, "onAwakeInit", 2);
  __decorateClass([
    property3({ tips: "\u5206\u7EC4\uFF0C\u9ED8\u8BA4\u662F1", type: Number })
  ], ShapeScipt.prototype, "group", 2);
  __decorateClass([
    property3({ tips: "\u78B0\u649E\u5F62\u72B6", type: ShapeType, catalog: "shapeInfo", catalogCaption: "\u7C7B\u578B" })
  ], ShapeScipt.prototype, "shapeType", 2);
  __decorateClass([
    property3({ tips: "\u77E9\u5F62\u5BBD", type: Number, caption: "width", hidden: "data.shapeType != 0", catalog: "shapeInfo" })
  ], ShapeScipt.prototype, "rectangleWidth", 2);
  __decorateClass([
    property3({ tips: "\u77E9\u5F62\u9AD8", type: Number, caption: "height", hidden: "data.shapeType != 0", catalog: "shapeInfo" })
  ], ShapeScipt.prototype, "rectangleHeight", 2);
  __decorateClass([
    property3({ tips: "\u5706\u534A\u5F84", type: Number, caption: "radius", hidden: "data.shapeType != 1", catalog: "shapeInfo" })
  ], ShapeScipt.prototype, "circleRadius", 2);
  ShapeScipt = __decorateClass([
    regClass3("4e1c4044-08f7-4814-8b7d-f00a5b994c38", "../src/frame/collision/ray/ShapeScript.ts")
  ], ShapeScipt);
  ...
  __name(LoadingWindow, "LoadingWindow");
  LoadingWindow = __decorateClass([
    regClass4("692cc058-0d5f-4762-ac4d-03191fd20a31", "../src/game/model/loading/view/LoadingWindow.ts")
  ], LoadingWindow);

  // src/game/model/loading/view/LoadingWindowRuntime.generated.ts
  var _LoadingWindowRuntimeBase = class _LoadingWindowRuntimeBase extends Laya.Box {
  };
  __name(_LoadingWindowRuntimeBase, "LoadingWindowRuntimeBase");
  var LoadingWindowRuntimeBase = _LoadingWindowRuntimeBase;
  ...
  __name(LoadingWindowRuntime, "LoadingWindowRuntime");
  ...
  __name(_MainMenuTabItemBase, "MainMenuTabItemBase");
  ...
  var _MainModel = class _MainModel {
  ...
  var _MainMenuWindowRuntimeBase = class _MainMenuWindowRuntimeBase extends Laya.Box {
  };
  __name(_MainMenuWindowRuntimeBase, "MainMenuWindowRuntimeBase");
  ...
  var _MainTabItemBase = class _MainTabItemBase extends Laya.Box {
  };
  __name(_MainTabItemBase, "MainTabItemBase");
  ...
  var _MainWindowRuntimeBase = class _MainWindowRuntimeBase extends Laya.Box {
  };
  __name(_MainWindowRuntimeBase, "MainWindowRuntimeBase");
  ...
  __name(_RepairItemBase, "RepairItemBase");
  var RepairItemBase = _RepairItemBase;
